...
output_file= dataDir + 'output0.txt'
...
# create a matrix with 6 rows and arbitrary columns/different between genre_vec=[[]]*6
				...
				for nn in range(0, 6):
					...
					for jj in range(0, length):
						if trainItemID == genre_vec[nn][jj]:
							user_rating_inTrain[nn, (jj + 3)] = trainRating
